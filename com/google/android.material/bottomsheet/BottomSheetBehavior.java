...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BottomSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.4
            ...
            /* JADX WARN: Code restructure failed: missing block: B:12:0x0037, code lost:
                ...
                if (com.google.android.material.bottomsheet.BottomSheetBehavior.this.shouldExpandOnUpwardDrag(r3, (r9 * 100.0f) / com.google.android.material.bottomsheet.BottomSheetBehavior.this.parentHeight) != false) goto L71;
             */
            /* JADX WARN: Code restructure failed: missing block: B:15:0x003e, code lost:
            
                if (r9 > com.google.android.material.bottomsheet.BottomSheetBehavior.this.halfExpandedOffset) goto L128;
             */
            /* JADX WARN: Code restructure failed: missing block: B:30:0x0095, code lost:
            
                if (java.lang.Math.abs(r8.getTop() - com.google.android.material.bottomsheet.BottomSheetBehavior.this.getExpandedOffset()) < java.lang.Math.abs(r8.getTop() - com.google.android.material.bottomsheet.BottomSheetBehavior.this.halfExpandedOffset)) goto L71;
             */
            /* JADX WARN: Code restructure failed: missing block: B:40:0x00d4, code lost:
            
                if (com.google.android.material.bottomsheet.BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging() == false) goto L128;
             */
            /* JADX WARN: Code restructure failed: missing block: B:44:0x00f6, code lost:
            
                if (java.lang.Math.abs(r9 - com.google.android.material.bottomsheet.BottomSheetBehavior.this.fitToContentsOffset) < java.lang.Math.abs(r9 - com.google.android.material.bottomsheet.BottomSheetBehavior.this.collapsedOffset)) goto L71;
             */
            /* JADX WARN: Code restructure failed: missing block: B:50:0x0114, code lost:
            
                if (com.google.android.material.bottomsheet.BottomSheetBehavior.this.shouldSkipHalfExpandedStateWhenDragging() != false) goto L104;
             */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0035, code lost:
        ...
        if (r4.getTop() <= r2.halfExpandedOffset) goto L108;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:36:0x0065, code lost:
        ...
        if (java.lang.Math.abs(r3 - r2.fitToContentsOffset) < java.lang.Math.abs(r3 - r2.collapsedOffset)) goto L108;
     */
    /* JADX WARN: Code restructure failed: missing block: B:43:0x007b, code lost:
    
        if (shouldSkipHalfExpandedStateWhenDragging() != false) goto L104;
     */
    /* JADX WARN: Code restructure failed: missing block: B:45:0x008b, code lost:
    
        if (java.lang.Math.abs(r3 - r1) < java.lang.Math.abs(r3 - r2.collapsedOffset)) goto L107;
     */
    /* JADX WARN: Code restructure failed: missing block: B:49:0x00a7, code lost:
    
        if (java.lang.Math.abs(r3 - r2.halfExpandedOffset) < java.lang.Math.abs(r3 - r2.collapsedOffset)) goto L107;
     */
    @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    ...
    public void setState(int i) {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            runAfterLayout(v, new Runnable() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.1
                ...
                AnonymousClass1(View v2, int i22) {
                    r2 = v2;
                    r3 = i22;
                }
        ...
        if (this.paddingBottomSystemWindowInsets || this.paddingLeftSystemWindowInsets || this.paddingRightSystemWindowInsets || this.marginLeftSystemWindowInsets || this.marginRightSystemWindowInsets || this.marginTopSystemWindowInsets || z) {
            ViewUtils.doOnApplyWindowInsets(view, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.3
                ...
                public WindowInsetsCompat onApplyWindowInsets(View view2, WindowInsetsCompat windowInsetsCompat, ViewUtils.RelativePadding relativePadding) {
                    ...
                    if (BottomSheetBehavior.this.paddingBottomSystemWindowInsets || r2) {
    ...
    class AnonymousClass4 extends ViewDragHelper.Callback {
        private long viewCapturedMillis;
