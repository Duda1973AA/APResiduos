...
class FloatingActionButtonImpl {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            createDefaultAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.1
                ...
                AnonymousClass1(boolean z2, InternalVisibilityChangedListener internalVisibilityChangedListener2) {
                    r2 = z2;
                    r3 = internalVisibilityChangedListener2;
                }

                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator2) {
                    FloatingActionButtonImpl.this.view.internalSetVisibility(0, r2);
                ...
                public void onAnimationEnd(Animator animator2) {
                    ...
                    InternalVisibilityChangedListener internalVisibilityChangedListener2 = r3;
    ...
    void show(InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            createDefaultAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.2
                ...
                AnonymousClass2(boolean z3, InternalVisibilityChangedListener internalVisibilityChangedListener2) {
                    r2 = z3;
                    r3 = internalVisibilityChangedListener2;
                }
    ...
    private AnimatorSet createDefaultAnimator(float f, float f2, float f3, int i, int i2) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.4
            ...
            AnonymousClass4(float f4, float f5, float f6, float f22, float f7, float f8, float f32, Matrix matrix) {
                r2 = f4;
                r3 = f5;
                r4 = f6;
                r5 = f22;
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                FloatingActionButtonImpl.this.view.setAlpha(AnimationUtils.lerp(r2, r3, 0.0f, 0.2f, floatValue));
                FloatingActionButtonImpl.this.view.setScaleX(AnimationUtils.lerp(r4, r5, floatValue));
                FloatingActionButtonImpl.this.view.setScaleY(AnimationUtils.lerp(r6, r5, floatValue));
                FloatingActionButtonImpl.this.imageMatrixScale = AnimationUtils.lerp(r7, r8, floatValue);
                FloatingActionButtonImpl.this.calculateImageMatrixFromScale(AnimationUtils.lerp(r7, r8, floatValue), r9);
                FloatingActionButtonImpl.this.view.setImageMatrix(r9);
            }
        });
        arrayList.add(ofFloat);
        AnimatorSetCompat.playTogether(animatorSet, arrayList);
