...
public final class QuantizerWsmeans {
    ...
    public static Map<Integer, Integer> quantize(int[] iArr, int[] iArr2, int i) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            iArr5[i5] = ((Integer) hashMap.get(Integer.valueOf(iArr4[i5]))).intValue();
        }
        ...
        for (int i10 = 0; i10 < i3; i10++) {
            iArr6[i10] = (int) Math.floor(Math.random() * min);
        }
        ...
        for (int i33 = 0; i33 < min; i33++) {
            ...
            if (i34 != 0) {
                ...
                if (!hashMap2.containsKey(Integer.valueOf(i35))) {
                    hashMap2.put(Integer.valueOf(i35), Integer.valueOf(i34));
                }
            }
        }
        return hashMap2;
