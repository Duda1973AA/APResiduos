        ...
        public void execute(Runnable runnable) {
            synchronized (this.mLock) {
                this.mTasks.add(new Runnable() { // from class: androidx.appcompat.app.AppLocalesStorageHelper$SerialExecutor$$ExternalSyntheticLambda0
                    ...
                    public /* synthetic */ AppLocalesStorageHelper$SerialExecutor$$ExternalSyntheticLambda0(Runnable runnable2) {
                        r2 = runnable2;
                    }

                    @Override // java.lang.Runnable
                    public final void run() {
                        AppLocalesStorageHelper.SerialExecutor.this.m6xd188c474(r2);
                    }
                });
