            ...
            if (!context.isRestricted()) {
                try {
                    Typeface font = tintTypedArray.getFont(i, this.mStyle, new ResourcesCompat.FontCallback() { // from class: androidx.appcompat.widget.AppCompatTextHelper.1
                        ...
                        AnonymousClass1(int i32, int i42, WeakReference weakReference) {
                            r2 = i32;
                            r3 = i42;
                            r4 = weakReference;
                        }
                        ...
                        public void m14x46c88379(Typeface typeface) {
                            ...
                            if (Build.VERSION.SDK_INT >= 28 && (i5 = r2) != -1) {
                                typeface = Api28Impl.create(typeface, i5, (r3 & 2) != 0);
                            }
                            AppCompatTextHelper.this.onAsyncTypefaceReceived(r4, typeface);
                        }
                    });
                    if (font != null) {
            ...
            if (textView != null) {
                if (ViewCompat.isAttachedToWindow(textView)) {
                    textView.post(new Runnable() { // from class: androidx.appcompat.widget.AppCompatTextHelper.2
                        ...
                        AnonymousClass2(TextView textView2, Typeface typeface2, int i) {
                            r2 = textView2;
                            r3 = typeface2;
                            r4 = i;
                        }
