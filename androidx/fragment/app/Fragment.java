...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle m47lambda$attachController$4$androidxfragmentappFragmentManager = this.mChildFragmentManager.m47lambda$attachController$4$androidxfragmentappFragmentManager();
        if (m47lambda$attachController$4$androidxfragmentappFragmentManager != null) {
            bundle.putParcelable("android:support:fragments", m47lambda$attachController$4$androidxfragmentappFragmentManager);
        }
    }
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(ActivityResultContract<I, O> activityResultContract, Function<Void, ActivityResultRegistry> function, ActivityResultCallback<O> activityResultCallback) {
        ...
        registerOnPreAttachListener(new OnPreAttachedListener() { // from class: androidx.fragment.app.Fragment.9
            ...
            void onPreAttached() {
                ...
                r3.set(((ActivityResultRegistry) r2.apply(null)).register(generateActivityResultKey, Fragment.this, r4, r5));
            }
        });
        return new ActivityResultLauncher<I>() { // from class: androidx.fragment.app.Fragment.10
            ...
            AnonymousClass10(AtomicReference atomicReference2, ActivityResultContract activityResultContract2) {
                r2 = atomicReference2;
                r3 = activityResultContract2;
            }

            @Override // androidx.activity.result.ActivityResultLauncher
            public void launch(I i, ActivityOptionsCompat activityOptionsCompat) {
                ActivityResultLauncher activityResultLauncher = (ActivityResultLauncher) r2.get();
            ...
            public void unregister() {
                ActivityResultLauncher activityResultLauncher = (ActivityResultLauncher) r2.getAndSet(null);
                if (activityResultLauncher != null) {
