    ...
    public static void dumpPoc(Object obj) {
        ...
        for (Field field : cls.getFields()) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals(PluginCall.CALLBACK_ID_DANGLING)) && ((!(obj2 instanceof Integer) || !obj2.toString().equals("0")) && ((!(obj2 instanceof Float) || !obj2.toString().equals("1.0")) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            for (Field field : layoutParams.getClass().getFields()) {
                try {
                    ...
                    if (field.getName().contains("To") && !obj.toString().equals(PluginCall.CALLBACK_ID_DANGLING)) {
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams layoutParams, String str) {
        ...
        for (Field field : layoutParams.getClass().getFields()) {
            try {
                ...
                if (name.contains("To") && !obj.toString().equals(PluginCall.CALLBACK_ID_DANGLING)) {
