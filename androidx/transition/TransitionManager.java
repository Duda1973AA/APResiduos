...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo60clone = transition.mo60clone();
        mo60clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo60clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo60clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo60clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo60clone = transition.mo60clone();
        sceneChangeSetup(viewGroup, mo60clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo60clone);
    }
