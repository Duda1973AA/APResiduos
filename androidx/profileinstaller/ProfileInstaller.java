...
public class ProfileInstaller {
    ...
    static void result(Executor executor, DiagnosticsCallback diagnosticsCallback, int i, Object obj) {
        executor.execute(new Runnable() { // from class: androidx.profileinstaller.ProfileInstaller$$ExternalSyntheticLambda0
            ...
            public /* synthetic */ ProfileInstaller$$ExternalSyntheticLambda0(int i2, Object obj2) {
                r2 = i2;
                r3 = obj2;
            }
            ...
            public final void run() {
                ProfileInstaller.DiagnosticsCallback.this.onResultReceived(r2, r3);
            }
        });
    }
    ...
    static void diagnostic(Executor executor, DiagnosticsCallback diagnosticsCallback, int i, Object obj) {
        executor.execute(new Runnable() { // from class: androidx.profileinstaller.ProfileInstaller$$ExternalSyntheticLambda1
            ...
            public /* synthetic */ ProfileInstaller$$ExternalSyntheticLambda1(int i2, Object obj2) {
                r2 = i2;
                r3 = obj2;
            }
            ...
            @Override // java.lang.Runnable
            public final void run() {
                ProfileInstaller.DiagnosticsCallback.this.onDiagnosticReceived(r2, r3);
            }
        });
    }
