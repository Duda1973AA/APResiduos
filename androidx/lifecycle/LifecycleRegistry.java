...
public class LifecycleRegistry extends Lifecycle {
    ...
    public void handleLifecycleEvent(Lifecycle.Event r2) {
        Intrinsics.checkNotNullParameter(r2, "event");
        enforceMainThreadIfNeeded("handleLifecycleEvent");
        moveToState(r2.getTargetState());
    }
    ...
    public static final class ObserverWithState {
        ...
        public final void dispatchEvent(LifecycleOwner owner, Lifecycle.Event r5) {
            Intrinsics.checkNotNullParameter(r5, "event");
            Lifecycle.State targetState = r5.getTargetState();
            this.state = LifecycleRegistry.INSTANCE.min$lifecycle_runtime_release(this.state, targetState);
            LifecycleEventObserver lifecycleEventObserver = this.lifecycleObserver;
            Intrinsics.checkNotNull(owner);
            lifecycleEventObserver.onStateChanged(owner, r5);
