    ...
    public static abstract class FontCallback {
        ...
        public final void callbackSuccessAsync(Typeface typeface, Handler handler) {
            getHandler(handler).post(new Runnable() { // from class: androidx.core.content.res.ResourcesCompat$FontCallback$$ExternalSyntheticLambda0
                ...
                public /* synthetic */ ResourcesCompat$FontCallback$$ExternalSyntheticLambda0(Typeface typeface2) {
                    r2 = typeface2;
                }

                @Override // java.lang.Runnable
                public final void run() {
                    ResourcesCompat.FontCallback.this.m14x46c88379(r2);
                }
            });
        }
        ...
        public final void callbackFailAsync(int i, Handler handler) {
            getHandler(handler).post(new Runnable() { // from class: androidx.core.content.res.ResourcesCompat$FontCallback$$ExternalSyntheticLambda1
                ...
                public /* synthetic */ ResourcesCompat$FontCallback$$ExternalSyntheticLambda1(int i2) {
                    r2 = i2;
                }

                @Override // java.lang.Runnable
                public final void run() {
                    ResourcesCompat.FontCallback.this.m13xb24343b7(r2);
                }
            });
        }
